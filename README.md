...
## 📁 Structure
Each file contains its own documentation — notes, comments, and usage tips are written directly in the source files. Sometimes there may also be an additional README file in a specific repository and info file, which serves as a description of the most important issues.
...
## 🔗 Compatibility
For systems other than Ubuntu, configuration changes may be necessary.
